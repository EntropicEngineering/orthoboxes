...
#define _SIMPLE_HID_DEVICE_H
	...
	/* Macros */
		...
		#define SIMPLE_HID_PLATFORM_DESCRIPTOR_SIZE 38
		...
		#define SIMPLE_HID_UINT 0x0003
		#endif
		#ifndef SIMPLE_HID_INT
		#define SIMPLE_HID_INT 0x0004
		#endif
		#ifndef SIMPLE_HID_FLOAT
		#define SIMPLE_HID_FLOAT 0x0005
		#endif
		#ifndef SIMPLE_HID_UTF8
		#define SIMPLE_HID_UTF8 0x0006
		#endif
		 ...
		 *
		 */
		#define SIMPLE_HID_DESCRIPTOR_CUSTOM(PAGE, APPLICATION, ARRAY, OBJECT, UINT, INT, FLOAT, UTF8) \
			SIMPLE_HID_PLATFORM_DESCRIPTOR_SIZE, DTYPE_DeviceCapability,\
			DCTYPE_Platform, \
			/* Reserved */ 0, \
			SIMPLE_HID_PLATFORM_UUID, \
			WORD_TO_BYTES_LE(SIMPLE_HID_VERSION), \
			WORD_TO_BYTES_LE(PAGE), WORD_TO_BYTES_LE(APPLICATION), WORD_TO_BYTES_LE(ARRAY), WORD_TO_BYTES_LE(OBJECT), WORD_TO_BYTES_LE(UINT), WORD_TO_BYTES_LE(INT), WORD_TO_BYTES_LE(FLOAT), WORD_TO_BYTES_LE(UTF8)
